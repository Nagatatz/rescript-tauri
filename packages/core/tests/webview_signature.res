...
let _check_set_size: (Webview.t, 'size) => promise<unit> = Webview.setSize
let _check_set_position: (Webview.t, 'position) => promise<unit> = Webview.setPosition
let _check_position: Webview.t => promise<'position> = Webview.position
let _check_size: Webview.t => promise<'size> = Webview.size
...
let _check_on_drag_drop_event: (
  Webview.t,
  Webview.dragDropEvent<'pos> => unit,
