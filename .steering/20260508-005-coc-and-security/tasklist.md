...
- [ ] **commit 2**: `CODE_OF_CONDUCT.md` を新規作成（Contributor Covenant 2.1 全文 + enforcement contact: nagata.hbdc@gmail.com + CC BY 4.0 attribution）→ コミット `✨ Add CODE_OF_CONDUCT.md (Contributor Covenant 2.1)`
